...
$result="";
  if (isset($_POST['submit'])) {
      ...
      // Gmail Password
      $mail->Password = 'Meet@3670';
      $mail->setFrom('info@chemallinternational.com');
      // Recipient Email ID where you want to receive emails
      $mail->addAddress('info@chemallinternational.com');
...
<head>
    ...
    <link rel="stylesheet" href="contact-from.css">
    <link rel="stylesheet" href="/Ccss/footer.css">
    ...
    <section id="header">
        <div class="header ">
          <div class="nav-bar">
            ...
            <div class="nav-list">
              <ul>
                <li><a href="../index/index.php" data-after="Home">Home</a></li>
                        ...
                        <li><a href="index.php" id="modal-btn" data-after="Get a Quote">Get a Quote</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="contactdet">
                ...
                <div class="row no-gutters">
                    <div class="col-lg-5 contact-info__wrapper gradient-brand-color p-5 order-lg-2">
                        ...
                        <ul class="contact-info__list list-style--none position-relative z-index-101">
                            <li class="mb-4 pl-4" style="font-size: 18px">
                                <span class="position-absolute"><i class="fas fa-envelope" aria-hidden="true"></i></span> &nbsp;chemallinternationalpvtltd@gmail.com
                            </li>
                            <li class="mb-4 pl-4" style="font-size: 18px">
                                <span class="position-absolute"><i class="fas fa-phone" aria-hidden="true"></i></span> &nbsp;+91&nbsp; 97146 38666                    </li>
                                <li class="mb-4 pl-4" style="font-size: 18px">
                                <span class="position-absolute"><i class="fab fa-whatsapp" aria-hidden="true"></i></span> &nbsp;+91&nbsp; 97146 38666                    </li>
                                <li class="mb-4 pl-4" style="font-size: 18px">
                                <span class="position-absolute"><i class="fas fa-map-marker-alt" aria-hidden="true"></i></span> &nbsp;&nbsp; Registered Office &amp; Works<br>&nbsp;&nbsp;Chemall International Pvt. Ltd.
                                <br> &nbsp;&nbsp;GF PL 83, Ambika Industry, <br> &nbsp;&nbsp;Saroli, Chorasi,
                                <br> &nbsp;&nbsp;Surat 395010, <br> &nbsp;&nbsp;
                                Gujarat, India.
                    ...
                    <div class="col-lg-7 contact-form__wrapper p-5 order-lg-1">
                        <form action="#" method="POST" class="contact-form form-validate" novalidate="novalidate">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label class="required-field" for="name">Country Code</label>
        ...
        <select name="countryCode" class="form-control" id="">
                ...
                <option data-countrycode="ZW" value="263">Zimbabwe (+263)</option>
                                ...
                                <div class="col-sm-12 mb-3">
                                    <div class="form-group">
                                    <label class="required-field" for="subject">Contact Number</label>
                        <input type="text" name="number" id="number" class="form-control" placeholder="Enter Contact Number" required="">  
                                </div>
                                </div>
...
<footer>
    ...
    <div class="footer-bottom">
        <p class="para">COPYRIGHT @2021 CHEMALLINTERNATIONAL.COM <span1></span1></p>
    </div>
  </footer>
<!-- end of footer  -->
</body>
